...
BPF_option
 ...
 | BPF_MICROSOFT_FASTCALL           { current_BPF->microsoft_fastcall=true; }
 | BPF_BORLAND_FASTCALL             { current_BPF->borland_fastcall=true; }
...
FN_TYPE
 : TYPE_INT            { $$=TY_INT; }
 | TYPE_PTR_TO_DOUBLE  { $$=TY_PTR_TO_DOUBLE;  /* temporary, as I hope! */ }
