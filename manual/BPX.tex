...
%*
\IFRU{Если указана опция \IT{--dump-fpu-never}, состояние регистров FPU никогда не будет выводиться.}{If \TT{--dump-fpu-never} option is set, FPU registers state will not be dumped.}
%*
