...
\IFRU{Tracer это отладчик командной строки для выполнения простых отладочных задач.}{Tracer is command-line debugger for performing simple debugging tasks.}
