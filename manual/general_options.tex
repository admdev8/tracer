...
<<<<<<< HEAD
\IFRU{Если указана опция \IT{-{}-no-dump-fpu}, состояние регистров FPU не будут показываться.}{If \TT{-{}-no-dump-fpu} option is set, FPU registers state will not be dumped.}
...
>>>>>>> 22f45717f310560d7b616fdafb38838ffb60ed62
